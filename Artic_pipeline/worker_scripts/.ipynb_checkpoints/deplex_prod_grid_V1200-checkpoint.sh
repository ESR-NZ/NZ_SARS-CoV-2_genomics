...
srun guppy_barcoder -t 32 --input_path ${LIB_PATH}_basecalled_link --save_path ${LIB_PATH}_barcodes --barcode_kits SQK-RBK004
srun guppy_barcoder -t 32 --input_path ${LIB_PATH}_basecalled_link --save_path ${LIB_PATH}_barcodes --barcode_kits SQK-RBK001
